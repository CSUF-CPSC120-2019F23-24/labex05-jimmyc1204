...
int main()
{
  ...
  std::cout << "\n They begin to drift apart as they reach zero." << std::endl;
  std::cout << sizeof(d2) << " bytes, value: " << d2 << std::endl;
  std::cout << sizeof(f2) << " bytes, value: " << f2 << std::endl;
  ...
  std::cout << "\n The numbers drift apart much like in the previous example, however they begin to seperate sooner. F2 reaches zero." << std::endl;
  std::cout << sizeof(d2) << " bytes, value: " << d2 << std::endl;
  std::cout << sizeof(f2) << " bytes, value: " << f2 << std::endl;
  ...
  std::cout << "\n The number being displayed in d3 is precise as opposed to f2; d3 displayes the exact number whole f2 claims it's inifite." << std::endl;
